...
# Usage: ./install.sh --token=<enroll_token> --server=https://console.example.com
# Or:    TOKEN=... SERVER=https://console sh -c "$(curl -fsSL https://console/agent/install.sh)"
set -eu
...
if [ -z "$TOKEN" ] || [ -z "$SERVER" ]; then
  ...
  echo "Usage: $0 --token=<enroll_token> --server=https://console.example.com"
  exit 1
fi
